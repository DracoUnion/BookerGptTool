...
def main():
    ...
    parser.add_argument("-m", "--model", default='gpt-3.5-turbo-16k', help="model name")
    ...
    trans_parser.add_argument("-l", "--limit", type=int, default=8000, help="max token limit")
    ...
    test_parser.add_argument("-l", "--limit", type=int, default=8000, help="max token limit")
    ...
    comm_parser.add_argument("-l", "--limit", type=int, default=8000, help="max token limit")
    ...
    shengcai_parser.add_argument("-l", "--limit", type=int, default=8000, help="max token limit")
