...
def main():
    ...
    parser.add_argument("-rr", "--repetition-regex", default=r'([\s\S]{2,100})\1{9}', help="re for repetition detection")
    ...
    code2book_parser.add_argument("-c", "--check", type=int, default=0, help="check times")
