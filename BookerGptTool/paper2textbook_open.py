# -*- coding: utf-8 -*-
"""
paper2textbook_open.py —— 多篇论文到可溯源教科书的完整编排器（open 变体）。

与 paper2textbook.py 共用同一套工具/模型/提示词，仅子命令名与类名加 open 后缀。
流程与固定工作流同 paper2textbook.py。
"""
...
class Paper2TextbookOpenOrchestrator(Paper2TextbookOpenMixin):
...
def reg_subparser(subparsers):
    ...
    parser.set_defaults(func=paper2textbook_open)
