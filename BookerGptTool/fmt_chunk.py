...
def reg_subparser(subparsers):
    fmt_chunk_parser = subparsers.add_parser("fmt-chunk", help="格式化或修复文本块")
    fmt_chunk_parser.add_argument("fname", help="EPUB 文件名")
    fmt_chunk_parser.add_argument("-t", "--threads", type=int, default=8, help="线程数")
    fmt_chunk_parser.add_argument("-l", "--limit", type=int, default=8000, help="分块大小上限")
    fmt_chunk_parser.add_argument("-rc", "--recur", action='store_true', help="是否递归")
    fmt_chunk_parser.add_argument("-x", "--excluding-re", default='', help="排除文件的正则")
    fmt_chunk_parser.add_argument("-r", "--round", type=int, default=3, help="修复轮次")
    fmt_chunk_parser.add_argument("-mr", "--multi-round", action='store_true', help="是否多轮")
    fmt_chunk_parser.add_argument("-D", "--debug", action='store_true', help="调试模式")
